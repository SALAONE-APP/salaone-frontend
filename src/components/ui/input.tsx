...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  ...
  if (isPassword) {
    return (
      <div className="relative w-full flex items-center" data-slot="input-wrapper">
        <input
        ...
        <button
          ...
          className="absolute right-3 flex items-center justify-center text-muted-foreground hover:text-foreground focus-visible:outline-none transition-colors"
          tabIndex={-1}
        >
